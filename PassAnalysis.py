...
def plot_both_slope_offset(df, save_dir, NShuffles=200):
...
if __name__ == '__main__':
    ...
    plot_field_bestprecession(df=singlefield_df, save_dir=single_plot_dir)
    plot_both_slope_offset(df=singlefield_df, save_dir=single_plot_dir, NShuffles=1000)
