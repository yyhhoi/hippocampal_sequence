...
from common.utils import stat_record, p2str, wwtable2text
...
from PassAnalysis import check_pass_nspikes
...
def main():
    ...
    plot_both_slope_offset_hc3(df=df, save_dir=save_dir, NShuffles=100)
